...
# ╔═╡ 4a367de6-a902-4843-aecc-7601e99dcf09
begin
	using DataFrames
	using CSV
	using Plots # default
...
# ╔═╡ 825e3500-b5ee-11ee-0b76-4fb7243b9a5f
html"""
<style>
	main {
		margin: 0 auto;
...
# ╔═╡ 86dd3f78-88f9-4aaf-b007-ed36988a6d7e
PlutoUI.TableOfContents()

# ╔═╡ 0c9731bf-8951-4004-809a-5c896c7a8735
md"# Preparations"

# ╔═╡ 8fe3b233-c26a-4422-9be9-3b53654d48aa
track,segments = get_track_and_segments("..//data//data_australia.csv");

# ╔═╡ ee6d0950-c12e-4c88-98e2-6763ad8360fd
plotlyjs()

# ╔═╡ 8acfa5c9-cc62-4f4a-bf94-79288446fe55
plot(track.distance, track.altitude)

# ╔═╡ aa70acc1-9a2b-42e1-8ab6-6ad31a702350
input_speed = fill(10., size(segments, 1))

# ╔═╡ 03cb86b7-9860-44fd-95d4-e2f2ab237547
md"# Тесты" 

# ╔═╡ 080bbd5a-5fa0-478c-a4a0-57f8faaee2b6
md"Что вообще хочется сравнить:
1. хорошо ли работает макрос @simd (подумать про остальные макросы: @inbounds, @fastmath)
2. влияние broadcasting
3. влияние типов???"

# ╔═╡ 2ff2e1b5-6180-4055-b84a-129d26ef4096
md"Ну и вообще надо сделать реализацию расчётов через for и без него с broadcasting" 

# ╔═╡ c6d270f4-a28d-4483-aa3a-063af5b13756
md"Что вообще можно сделать:
...
# ╔═╡ 166bb822-62b5-413a-862a-9e413bbe6128
md"## 0. Одно значение"

# ╔═╡ 56e51f6c-e8fb-434e-8865-07d10358a9ef
@time mechanical_power_calculation_alloc_typed(input_speed[1], segments.slope[1], segments.diff_distance[1])

# ╔═╡ 301501dc-d47d-421b-abd6-d073e054699c
...
@time mechanical_power_calculation_elem(input_speed, segments.slope, segments.diff_distance)
